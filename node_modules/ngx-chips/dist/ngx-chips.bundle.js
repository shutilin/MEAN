(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('ng2-material-dropdown'), require('rxjs/Observable'), require('rxjs/observable/of'), require('rxjs/operators'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'ng2-material-dropdown', 'rxjs/Observable', 'rxjs/observable/of', 'rxjs/operators', '@angular/animations'], factory) :
	(factory((global['ngx-chips'] = {}),global.ng.core,global.ng.forms,global.ng.common,global.ng2MaterialDropdown,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.ng.animations));
}(this, (function (exports,core,forms,common,ng2MaterialDropdown,Observable,of,operators,animations) { 'use strict';
...
var TagInputComponent = /** @class */ (function (_super) {
    ...
    function TagInputComponent(renderer, dragProvider) {
        ...
        _this.onPasteCallback = function (data) {
            var /** @type {?} */ text = data.clipboardData.getData('text/plain');
    ...
    TagInputComponent.prototype.onRemoveRequested = function (tag, index) {
        ...
        this.onRemoving ?
            this.onRemoving(tag).pipe(operators.first())
    ...
    TagInputComponent.prototype.onAddingRequested = function (fromAutocomplete, tag, index) {
        ...
        this.onAdding ?
            this.onAdding(tag).pipe(operators.first())
                .subscribe(subscribeFn) : subscribeFn(tag);
    };
    /**
     * \@name selectItem
    ...
    TagInputComponent.prototype.addItem = function (fromAutocomplete, item, index) {
         ...
         * @param tag
         */
        var /** @type {?} */ validationFilter = function (tag) {
            var /** @type {?} */ isValid = _this.isTagValid(tag, fromAutocomplete) && _this.inputForm.form.valid;
            if (!isValid) {
         ...
         * @param tag
         */
        var /** @type {?} */ subscribeFn = function (tag) {
        ...
        of.of(model).pipe(operators.first(), operators.filter(function () { return model.trim() !== ''; }), operators.map(function () { return item; }), operators.map(this.createTag), operators.filter(validationFilter)).subscribe(subscribeFn, undefined, reset);
    };
    /**
    ...
    TagInputComponent.prototype.setUpTextChangeSubscriber = function () {
        ...
        this.inputForm.form
            .valueChanges
            .pipe(operators.debounceTime(this.onTextChangeDebounce), operators.map(function () { return _this.formValue; }))
