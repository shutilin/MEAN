...
var TagInputComponent = /** @class */ (function (_super) {
    ...
    TagInputComponent.prototype.addItem = function (fromAutocomplete, item, index) {
        ...
        of$1(model).pipe(first(), filter(function () { return model.trim() !== ''; }), map(function () { return item; }), map(this.createTag), filter(validationFilter)).subscribe(subscribeFn, undefined, reset);
    };
    /**
    ...
    TagInputComponent.prototype.setUpTextChangeSubscriber = function () {
        ...
        this.inputForm.form
            .valueChanges
            .pipe(debounceTime(this.onTextChangeDebounce), map(function () { return _this.formValue; }))
